...
// Filter
const transactionss = [5000, -2000, 500, -500, 3000, -2000, 6000, -1500];
...
const numberss = [23, 22, 44, 56, 78, 53, 32, 33];
...
const numberssss = [55, 42, 12, 55, 26, 32, 87, 98];
...
const transactionsss = [500, 200, -300, -150, 500, 200, -50];

const withdrawalss = transactions.filter((transaction) => transaction < 0);
console.log(withdrawals);

// Reduce
const movementss = [500, 200, -300, -150, 500, 200, -50];
...
const multi = arrr.reduce((acc, el) => acc * el, 1);
console.log(multi);

// Maximum
const arrr2 = [21, 55, 45, 87, 5, 99, 63, 21, 45];

const max = arrr2.reduce((acc, value) => (acc > value ? acc : value), arr2[0]);
console.log(max);

// Minimum
const min = arrr2.reduce(function (acc, value) {
  if (acc < value) {
    return acc;
  } else {
    return value;
...
// Data transformation pipeline
const movementsss = [500, 200, -300, -150, 500, 200, -50];

const totalDeposit = movementsss
  .filter((move) => move > 0)
...
// Find
const movementes = [500, 200, -300, -150, 500, 200, -50];

// console.log(movements.at(2));

const firstWithdrawal = movementes.find((move) => move < 0);
...
/// Some and every
const arr33 = [17, 22, 35, 11, 3, 18, 15];

const anyNumberGreater40 = arr33.some((number) => number > 40); //.any
console.log(anyNumberGreater40);

const everyNumberGreater10 = arr33.every((number) => number > 10);
console.log(everyNumberGreater10);

// flat and flatmap
const arr5 = [11, 22, [56, 45], 24, [55, [44, 88]], 74];
...
// Sorting (rarely)
const studentss = ["Sarah", "Mim", "Rina", "Ayesha", "Tumpa"];
...
const arr6 = [18, 155, 31, 422, 333, 61, 29];
...
const sortedArr = arr6.sort((a, b) => a - b); // ascending
